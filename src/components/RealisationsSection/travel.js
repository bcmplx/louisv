...
const travel = ({
	...
	const extraDesc = <a href="https://travel-louisvillain.netlify.app/" target="_blank" rel="noreferrer" >Lien vers le site (nouvel onglet)</a>;


	const AnimTitle = animatedCss('Travel', 1000, animation1, 'fadeOutLeft');
	const AnimTopLine = animatedCss('Projet perso', 1000, animation2, 'fadeOutLeft');
	const AnimDescription = animatedCss('Projet réalisé en React, en utilisant Gatsby et GraphQl', 2000, animation3, 'fadeOutLeft');
